          ...
          >
            ...
            <div className="text-center border-b-2 border-slate-800 pb-4 space-y-1">
              ...
              <p className="text-xs font-bold text-slate-700">
                Phone: +91 {company.phone} | GSTIN: {company.gstin}
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 border-b border-gray-200 pb-3">
              ...
              <div className="text-right text-xs text-slate-500">
                ...
                <div>System: <strong>BEES HUB FARMLAND PVT LTD Enterprise Accounting</strong></div>
              </div>
            </div>

            {/* Net Result Highlight Summary */}
            <div className={`p-4 rounded-xl border flex items-center justify-between ${report.isProfit
            ...
            <div className="mt-8 pt-4 border-t border-slate-300 flex justify-between items-end text-xs text-slate-500">
              <div>
                <p className="font-semibold text-slate-700">{company.name} | GSTIN: {company.gstin}</p>
